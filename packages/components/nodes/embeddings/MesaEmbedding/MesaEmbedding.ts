...
class MesaEmbedding_Embeddings implements INode {
    label: string
    name: string
    version: number
    type: string
    ...
    constructor() {
        this.label = 'MESA Embeddings'
        this.name = 'MesaEmbeddings'
        this.version = 1.0
        this.type = 'MESA Embeddings'
...
module.exports = { nodeClass: MesaEmbedding_Embeddings }
